...
describe("Testing GenerateObject", function() {
  ...
  it("Test with multiple cases", function(done) {
    ...
    go.insertElement({ item: "tuna", column: "aisle" }, "(item):(column)", 10);
  ...
  it("Make sure null data is not inserted", function(done) {
    ...
    go.insertElement({ item: "salmon", column: "id" }, "(item):(column)", null);
  ...
  it("Test object flattening with two insertions", function(done) {
    ...
    go.insertElement({ item: "tuna" }, "(item):in", "the ocean", "place");
    go.insertElement(
      { item: "tuna", column: "aisle" },
      "(item):(column)",
      10,
  ...
  it("Test info insertion and retrieval", function(done) {
    ...
    let info = {
      text: "The tuna is in the ocean may friend",
      phrase: "The (item) is in the (value)"
    };
    go.insertElement({ item: "tuna" }, "(item):in", "the ocean", "place", info);
